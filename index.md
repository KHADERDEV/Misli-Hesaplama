...
Misli Hesaplama is a simple mobile app.
...
We do not use advertising data to show ads inside the app.
...
* The name of the app: **Misli Hesaplama**.
* The email address used to contact us, if applicable.
* A clear request to delete your data.

We will review and process deletion requests where required by applicable law.
...
If you believe that a child has provided personal information, please contact us at:
...
For copyright complaints or abuse reports, contact:

**[abuse@miniapq.com](mailto:abuse@miniapq.com)**
